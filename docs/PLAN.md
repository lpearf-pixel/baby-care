...
Current implementation milestone: **M5 — Voice Care Adapter and Feeding Pilot — Tasks 1-4 complete; Task 5 next**
...
- next: Task 5 signed device endpoint and pending feeding state machine
