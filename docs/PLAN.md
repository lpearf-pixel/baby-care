...
Current implementation milestone: **M5 — Voice Care Adapter and Feeding Pilot — Task 1 complete; Task 2 next**
...
- next: Task 2 database schema and fail-closed invariants
